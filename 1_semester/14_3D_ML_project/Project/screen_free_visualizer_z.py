...
class Visualizer(object):
    ...
    def __render_pred_verts(self, img_original, pred_mesh_list_body, pred_mesh_list_garment, texture_rgb):
        ...
        for mesh_body, mesh_garment in zip(pred_mesh_list_body, pred_mesh_list_garment):
            ...
            rend_img, mesh = self.renderer.render(verts_body, faces_body, verts_garment, faces_garment, rend_img, texture_rgb)
    ...
    def visualize(self, 
        ...
        if (pred_mesh_list_body is not None) and (pred_mesh_list_garment is not None):
            rend_img, mesh = self.__render_pred_verts(input_img, pred_mesh_list_body, pred_mesh_list_garment, texture_rgb)
